...
@Component({
  ...
  styleUrl: './employee-approvals.component.css'
})
  ...
  constructor(private EmployeeService:EmployeeService,
    ...
    ngOnInit(): void {
     ...
     if (this.userId !== null) {
       ...
       selectedApproval: any = null; // To store the selected approval details

       // Method to handle the click and store the approval details
       ShowRequestDetails(approval: any) {
         this.selectedApproval = approval; // Store the selected approval
       }
